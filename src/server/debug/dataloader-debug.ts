 ...
 */
export const dataLoaderStatsResolver = {
  // 查询 DataLoader 统计信息
  dataLoaderStats: async (_: any, context: DataLoaderContext) => {
    try {
  ...
  // 清除 DataLoader 缓存
  clearDataLoaderCache: async (_: any, context: DataLoaderContext) => {
    try {
 ...
 */
export const dataLoaderDebugSchema = {
  query: `
