 ...
 * 应用项目配置到生成的文件中
 */
export function applyProjectConfig(projectPath: string, config: ProjectConfig): void {
  // 更新 package.json
 ...
 * 确保默认功能配置正确应用
 */
function ensureDefaultFeatures(config: ProjectConfig): void {
 ...
 * 更新 package.json 文件
 */
function updatePackageJson(projectPath: string, config: ProjectConfig): void {
 ...
 * 更新 README.md 文件
 */
function updateReadme(projectPath: string, config: ProjectConfig): void {
