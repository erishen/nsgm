...
var initFiles = function (dictionary, upgradeFlag) {
    ...
    if (!isLocal && !upgradeFlag) {
        if (dictionary !== '') {
            ...
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev @types/node@20.14.11 --legacy-peer-deps');
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev @types/react@18.3.3 --legacy-peer-deps');
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev @types/lodash@4.17.7 --legacy-peer-deps');
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev babel-plugin-styled-components@2.1.4 --legacy-peer-deps');
        }
        else {
            ...
            shelljs_1.default.exec('npm install --save-dev @types/node@20.14.11 --legacy-peer-deps');
            shelljs_1.default.exec('npm install --save-dev @types/react@18.3.3 --legacy-peer-deps');
            shelljs_1.default.exec('npm install --save-dev @types/lodash@4.17.7 --legacy-peer-deps');
            shelljs_1.default.exec('npm install --save-dev babel-plugin-styled-components@2.1.4 --legacy-peer-deps');
        }
    }
