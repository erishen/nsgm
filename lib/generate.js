...
var initFiles = function (dictionary, upgradeFlag) {
    ...
    if (!isLocal && !upgradeFlag) {
        if (dictionary !== '') {
            ...
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev @types/node@^20 --legacy-peer-deps');
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev @types/react@^18 --legacy-peer-deps');
            shelljs_1.default.exec('cd ' + dictionary + ' && npm install --save-dev @types/lodash@^4 --legacy-peer-deps');
            ...
            shelljs_1.default.exec('npm install --save-dev @types/node@^20 --legacy-peer-deps');
            shelljs_1.default.exec('npm install --save-dev @types/react@^18 --legacy-peer-deps');
            shelljs_1.default.exec('npm install --save-dev @types/lodash@^4 --legacy-peer-deps');
